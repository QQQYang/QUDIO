"""
Implement hardware-efficient ansatz by torch
...
def circuit(param, hamiltonian, p=0, M=100):
    ...
    for j in range(n_layers):
        ...
        for i in range(n_qubits):
            x = kronecker(x, Rot(param[j, i, 0], param[j, i, 1], param[j, i, 2]))
...
class VQE_HE(torch.nn.Module):
    def __init__(self, n_qubits, hamiltonian, p=0, M=100, param_shift=False, n_layers=2):
        super().__init__()
